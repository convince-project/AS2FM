...
The main structure of the SCXML related state machines can be seen in the diagram below:
...
Here the structure of a Client-Server communication through actions and additional threads:
