...
"""
Helper functions used in `moco.roaml_generator.scxml_helpers.scxml_to_jani_interfaces`.
"""
...
from moco.moco_common.array_type import ArrayInfo, get_array_type_and_sizes
...
from moco.moco_common.logging import check_assertion, get_error_msg, log_warning
...
from moco.roaml_generator.scxml_helpers.scxml_event import Event, EventParamType, EventsHolder
    ...
    for i, ec in enumerate(body):
        ...
        if isinstance(ec, ScxmlAssign):
            ...
            for param in ec.get_params():
                ...
                # See https://github.com/convince-project/moco/issues/84
