...
def main_jani_to_plantuml():
    ...
    parser.add_argument(
        "--no-syncs", action="store_true", help="Don't connects transitions that are synchronized."
    )
    parser.add_argument(
        "--no-assignments", action="store_true", help="Don't show assignments on the edges."
    )
