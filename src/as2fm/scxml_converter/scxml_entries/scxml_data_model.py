...
class ScxmlDataModel(ScxmlBase):
    ...
    def as_xml(self, type_as_argument: bool = True) -> Optional[ET.Element]:
        """
        Store the datamodel, containing all model's data entries, as an XML element.

        :param type_as_argument: If True, store data types as arguments, if False as Comments
        """
