...
class ScxmlRosDeclarationsContainer:
    ...
    def append_ros_declaration(self, scxml_ros_declaration: ScxmlBase) -> None:
        ...
        """
        from as2fm.scxml_converter.scxml_entries.scxml_ros_action_client import \
            RosActionClient
        ...
        from as2fm.scxml_converter.scxml_entries.scxml_ros_service import (
            RosServiceClient, RosServiceServer)
        from as2fm.scxml_converter.scxml_entries.scxml_ros_timer import \
            RosTimeRate
    ...
    def check_valid_action_goal_fields(
            self, alias_name: str, ros_fields: List[RosField]) -> bool:
        """
