...
class TestConversion(unittest.TestCase):
    ...
    def test_battery_drainer(self):
        ...
        scxml_root = load_scxml_file(scxml_battery_drainer, {})
        eh = EventsHolder()
        jani_automaton = convert_scxml_root_to_jani_automaton(scxml_root, eh, 100)
    ...
    def test_battery_manager(self):
        ...
        scxml_root = load_scxml_file(scxml_battery_manager, {})
        eh = EventsHolder()
        jani_automaton = convert_scxml_root_to_jani_automaton(scxml_root, eh, 100)
    ...
    def test_example_with_sync(self):
        ...
        scxml_battery_drainer = load_scxml_file(scxml_battery_drainer_path, {})
        scxml_battery_manager = load_scxml_file(scxml_battery_manager_path, {})
